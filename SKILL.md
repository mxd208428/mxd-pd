...
| 一级标题段前段后间距 | 1段前段后各0.5行 2段前段后各1行 3段前1行段后0.5行 4其他 |
...
| 二级标题段前段后间距 | 1段前段后各0.5行 2段前段后各1行 3段前0.5行段后0 4其他 |
| 三级标题字体/字号/加粗 | 1仿宋四号加粗 2宋体小四加粗 3黑体四号加粗 4其他 |
| 四级标题+首行缩进 | 1四级与正文相同+缩进2字符 2四级仿宋小四加粗+缩进2字符 3四级宋体小四加粗+缩进1字符 4其他 |
